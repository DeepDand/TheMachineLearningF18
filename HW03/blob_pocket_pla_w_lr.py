...
class Perceptron:
    ...
    def plot(self, mispts=None, vec=None, save=False):
        ...
        if save:
            ...
            plt.savefig('Blob_LR_N%s' % (str(len(self.X))), dpi=200, bbox_inches='tight')
    ...
    def pla(self, save=False):
        ...
        for i in range(100):
            ...
            if save:
                ...
                plt.title('N = %s, Iteration %s, misclassified %s\n' % (str(N),str(it), str(len(mispts))))
                plt.savefig('Blob_LR_N%s_it%s' % (str(N),str(it)), dpi=200, bbox_inches='tight')
